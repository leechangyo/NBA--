...
def createModel(startYear=None, startMonth=None, startDay=None, endYear=None, endMonth=None, endDay=None, season='2021-22', startOfSeason = '10/19/2021', filename='model.pkl'):
    ...
    allGamesDataframe = pd.read_csv('combinedgamewithifo20-22.csv')  # Should be commented out if needing to obtain data on different range of games
...
if __name__ == "__main__":
    createModel(2021, 10, 19, 2022, 4, 10)