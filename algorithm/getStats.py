...
def getStatsForTeam(team, startDate, endDate, season='2019-20'):
    ...
    # created by chan
    generalTeamInfo = teamdashboardbygeneralsplits.TeamDashboardByGeneralSplits(team_id=teams[team], per_mode_detailed='Per100Possessions', date_from_nullable='', date_to_nullable='', season=Season.default, headers=customHeaders, timeout=120)
    ...
    advancedTeamInfo = teamdashboardbygeneralsplits.TeamDashboardByGeneralSplits(team_id=teams[team], measure_type_detailed_defense='Advanced', date_from_nullable='', date_to_nullable='', season=Season.default, headers=customHeaders, timeout=120)
